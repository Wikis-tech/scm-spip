...
// Prevent known-offline database requests from silently falling back to local memory in production.
...
// Vercel imports the Express app as a serverless handler. Local development still starts a listener.
